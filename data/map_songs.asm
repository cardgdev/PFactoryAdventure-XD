...
MapSongBanks:
	...
	db MUSIC_MEET_EVIL_TRAINER, BANK(Music_MeetEvilTrainer) ; CeladonMansion3
	...
	db MUSIC_INDIGO_PLATEAU, BANK(Music_IndigoPlateau) ; Bruno
	db MUSIC_INDIGO_PLATEAU, BANK(Music_IndigoPlateau) ; Agatha
