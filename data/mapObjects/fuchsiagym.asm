FuchsiaGymObject:
	...
	db $8 ; objects
	object SPRITE_BLACKBELT, $3, $b, STAY, DOWN, $1, OPP_TSUKUSHI, $1
	object SPRITE_ROCKER, $8, $d, STAY, DOWN, $2, OPP_JUGGLER, $7
	object SPRITE_ROCKER, $6, $8, STAY, RIGHT, $3, OPP_JUGGLER, $3
	object SPRITE_ROCKER, $9, $5, STAY, DOWN, $4, OPP_JUGGLER, $8
	object SPRITE_ROCKER, $0, $2, STAY, UP, $5, OPP_TAMER, $1
	object SPRITE_ROCKER, $7, $1, STAY, DOWN, $6, OPP_TAMER, $2
	object SPRITE_ROCKER, $2, $6, STAY, LEFT, $7, OPP_JUGGLER, $4
