SilphCo11Object:
	...
	object SPRITE_GIOVANNI, $6, $9, STAY, DOWN, $3, OPP_BLAINE, $2
	object SPRITE_ROCKET, $3, $10, STAY, UP, $4, OPP_SOLDIER, $29
	object SPRITE_ROCKET, $f, $9, STAY, UP, $5, OPP_SOLDIER, $28
