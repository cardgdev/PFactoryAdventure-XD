SaffronGymObject:
	...
	db $9 ; objects
	object SPRITE_ROCKER, $9, $8, STAY, DOWN, $1, OPP_JACK, $1
	object SPRITE_BLACK_HAIR_BOY_2, $a, $1, STAY, DOWN, $2, OPP_SUPER_NERD, $6
	object SPRITE_BUG_CATCHER, $11, $1, STAY, DOWN, $3, OPP_PSYCHIC_TR, $1
	object SPRITE_BLACK_HAIR_BOY_2, $3, $7, STAY, DOWN, $4, OPP_SUPER_NERD, $7
	object SPRITE_BUG_CATCHER, $11, $7, STAY, DOWN, $5, OPP_PSYCHIC_TR, $2
	object SPRITE_BLACK_HAIR_BOY_2, $3, $d, STAY, DOWN, $6, OPP_SUPER_NERD, $8
