MtMoon3Object:
	...
	object SPRITE_ROCKET, $b, $10, STAY, DOWN, $2, OPP_SOLDIER, $1
	object SPRITE_ROCKET, $f, $16, STAY, DOWN, $3, OPP_SOLDIER, $2
	object SPRITE_ROCKET, $1d, $b, STAY, UP, $4, OPP_SOLDIER, $3
	object SPRITE_ROCKET, $1d, $11, STAY, LEFT, $5, OPP_SOLDIER, $4
