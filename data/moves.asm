...
MoveEnd:
	...
	move DREAM_EATER,  DRAIN_HP_EFFECT,             75, GHOST,    100, 10
	move LOW_KICK,     OHKO_EFFECT,                  1, NORMAL,    30,  5
	move SLUDGE,       NO_ADDITIONAL_EFFECT,        90, POISON,   100, 10
	move SMOG,         SLEEP_EFFECT,                 0, POISON,    80, 15
	move THUNDERBOLT,  PARALYZE_SIDE_EFFECT1,       80, PSYCHIC,  100, 15
	...
	move POISON_GAS,   PARALYZE_SIDE_EFFECT2,       80, ELECTRIC,  95, 10
	move SCREECH,      DEFENSE_DOWN_SIDE_EFFECT,    95, NORMAL,   100,  5
	move CUT, NO_ADDITIONAL_EFFECT, 90, BUG, 100, 10
	move ACID_ARMOR, EVASION_UP1_EFFECT, 0, UNKNOWN, 100, 10
	move SOLARBEAM,    CHARGE_EFFECT,              120, UNKNOWN,    100, 10
	move SAND_ATTACK, FREEZE_SIDE_EFFECT, 70, ICE, 100, 20
	move SLASH, NO_ADDITIONAL_EFFECT, 70, FIRE, 100, 20
	move TRI_ATTACK, NO_ADDITIONAL_EFFECT, 80, PSYCHIC, 100, 10
	move EXPLOSION, EXPLODE_EFFECT, 170, BUG, 100, 5
	move CONFUSE_RAY, SWIFT_EFFECT, 50, PSYCHIC, 100, 15
	move MEGA_DRAIN,   DRAIN_HP_EFFECT,             60, ARMOR,    100, 10
	move VINE_WHIP, DEFENSE_DOWN_SIDE_EFFECT, 100, ARMOR, 80, 10
	move DRILL_PECK,   NO_ADDITIONAL_EFFECT,        80, ARMOR,   100, 20
	move WING_ATTACK,  NO_ADDITIONAL_EFFECT,        90, ARMOR,   100, 10
	move WATERFALL,       THRASH_PETAL_DANCE_EFFECT,   90, WATER,   100, 20
	move MEGA_PUNCH,  DEFENSE_DOWN_SIDE_EFFECT, 90, POISON, 100, 15
	move PSYCHIC_M,  FLINCH_SIDE_EFFECT1, 100, PSYCHIC, 100, 10
	move CLAMP, NO_ADDITIONAL_EFFECT, 100, ARMOR, 100, 10
	move EGG_BOMB, SWIFT_EFFECT, 80, FIGHTING, 100, 20
	move NIGHT_SHADE,  SPECIAL_DAMAGE_EFFECT,        0, UNKNOWN,    100, 15
	move ROCK_SLIDE,       SPEED_DOWN_SIDE_EFFECT,      70, ROCK,    100, 15 ; tombstoner
	move WHIRLWIND,    CONFUSION_SIDE_EFFECT,   110, FLYING,    70, 10
