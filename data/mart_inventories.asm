...
; Viridian
SharedMartText::
	TX_MART SURFBOARD, MASTER_BALL, POKE_BALL, GREAT_BALL, ULTRA_BALL, ESCAPE_ROPE, ANTIDOTE, PARLYZ_HEAL, BURN_HEAL, FULL_HEAL, POTION, SUPER_POTION, HYPER_POTION, REVIVE, REPEL, SUPER_REPEL
